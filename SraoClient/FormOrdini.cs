...
namespace SraoClient
{
    ...
    {
        Data DataOrdini;
        public FormOrdini(Data dataOrdini)
        {
            InitializeComponent();
        ...
        private void FormOrdini_Load(object sender, EventArgs e)
        {
            ...
            var ordini = DataOrdini.Ordini.OrderByDescending(x => x.Lavori.FirstOrDefault().DataInizio).ToList();
